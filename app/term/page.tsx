        ...
        <div className="space-y-8 pt-2">
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs md:text-sm text-zinc-500 leading-relaxed font-medium">
              Selamat datang di Ayocuci. Kami sangat menghargai kepercayaan Anda dan berkomitmen untuk melindungi data pribadi Anda. Kebijakan Privasi ini menjelaskan bagaimana kami mengumpulkan, menggunakan, dan melindungi informasi Anda saat menggunakan aplikasi dan layanan kami.
            </p>
            <p className="text-xs md:text-sm text-zinc-500 leading-relaxed font-medium">
          ...
          <div className="space-y-3">
            ...
            <ul className="list-disc pl-5 text-xs md:text-sm text-zinc-500 space-y-1.5 font-medium">
              <li>Menyediakan dan memelihara fitur aplikasi kasir laundry Anda.</li>
